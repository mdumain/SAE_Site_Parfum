...
'''
    ...
    mycursor.execute(sql)
    sql = ''' 
    INSERT INTO parfum VALUES (NULL, "Spider-Man", 10, 1, 3, 1, 1, 1, "Un parfum dynamique et énergisant, inspiré par l'agilité et l'héroïsme de Spider-Man. Notes de citron, de gingembre et de bois.", "spiderman.jpg"),
